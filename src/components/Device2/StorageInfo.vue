...
export default {
  ...
  computed: {
    storageUsage () {
      const totalStr = this.deviceInfo.totalStorage
      const usedStr = this.deviceInfo.usedStorage
    ...
    memoryUsage () {
      const totalStr = this.deviceInfo.totalMemory
      const usedStr = this.deviceInfo.usedMemory

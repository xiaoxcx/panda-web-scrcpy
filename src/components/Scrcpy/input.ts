...
//     public static async register(device: USBDevice): Promise<AoaKeyboardInjector> {
//         const keyboard = await AoaHidDevice.register(device, 0, HidKeyboard.DESCRIPTOR);
//         return new AoaKeyboardInjector(keyboard);
//     }
//
//     private readonly aoaKeyboard: AoaHidDevice;
//     private readonly hidKeyboard: HidKeyboard = new HidKeyboard();
//
